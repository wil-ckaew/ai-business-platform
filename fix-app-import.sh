...
echo "🔧 Corrigindo importação do DashboardLayout..."

# 1. Verificar se DashboardLayout existe
if [ ! -f "components/layout/DashboardLayout.js" ]; then
  echo "❌ DashboardLayout.js não encontrado! Criando..."
...
# 3. Verificar se MobileMenu existe
if [ ! -f "components/MobileMenu.js" ]; then
  echo "⚠️ Criando MobileMenu.js..."
...
# 4. Verificar se Header existe
if [ ! -f "components/layout/Header.js" ]; then
  echo "⚠️ Criando Header.js..."
...
# 5. Verificar se Sidebar existe
if [ ! -f "components/layout/Sidebar.js" ]; then
  echo "⚠️ Criando Sidebar.js..."
...
echo "📄 _app.js agora importa DashboardLayout corretamente"
echo ""
