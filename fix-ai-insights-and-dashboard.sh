...
echo "🔧 Corrigindo páginas dashboard e ai-insights..."

# 1. Corrigir ai-insights.js - remover chamadas de API e usar dados mock
...
# 2. Corrigir dashboard/index.js - remover DashboardLayout e usar conteúdo direto
...
echo "📋 Alterações:"
echo "   • ai-insights.js: Removidas chamadas de API, usando dados mock"
echo "   • dashboard/index.js: Removido DashboardLayout e importações desnecessárias"
echo "   • Ambas as páginas agora retornam apenas conteúdo"
echo ""
