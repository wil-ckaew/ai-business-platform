...
# 2. Criar MobileMenu correto (sem erro de sintaxe)
...
echo "✅ MobileMenu criado corretamente"

# 3. RESOLVER PÁGINAS DUPLICADAS: Remover TODOS os arquivos soltos e usar APENAS pastas
echo "🔄 Resolvendo páginas duplicadas..."

# Remover arquivos soltos que causam duplicação
rm -f pages/analytics.js pages/customers.js pages/sales.js pages/ai-dashboard.js 2>/dev/null || true

# Garantir que as pastas existam e tenham index.js
for page in analytics customers sales; do
  mkdir -p pages/$page
  ...
  return (
    <div className="space-y-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">${page^} content and insights</p>
      </div>
...
# 4. Criar ai-dashboard como pasta também (para consistência)
mkdir -p pages/ai-dashboard
cat > pages/ai-dashboard/index.js << 'AIDASHBOARD'
...
# 5. Atualizar dashboard para usar a pasta corretamente
if [ -f "pages/dashboard/index-simple.js" ]; then
  mv "pages/dashboard/index-simple.js" "pages/dashboard/index.js"
elif [ -f "pages/dashboard/index-v2.js" ]; then
  mv "pages/dashboard/index-v2.js" "pages/dashboard/index.js"
fi

# 6. Atualizar o menu no Sidebar para usar as rotas corretas
...
# 7. Atualizar o Header para mostrar título dinâmico
...
echo "   1. ✅ MobileMenu com erro de sintaxe"
echo "   2. ✅ Páginas duplicadas removidas"
echo "   3. ✅ Estrutura consistente (todas as páginas em pastas)"
echo "   4. ✅ Header com título dinâmico"
echo "   5. ✅ Sidebar com highlight ativo"
echo ""
echo "🚀 PARA INICIAR:"
echo "   npm run dev"
echo ""
...
echo "   - http://localhost:3000/ai-dashboard"
