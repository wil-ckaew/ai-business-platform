...
echo "🔧 Adicionando DashboardLayout às páginas..."

# Corrigir dashboard/index.js para usar DashboardLayout
...
# Corrigir ai-insights.js para usar DashboardLayout
...
echo ""
echo "✅ DashboardLayout adicionado às páginas!"
echo "📋 Principais mudanças:"
echo "   • dashboard/index.js agora usa DashboardLayout"
echo "   • dashboard/ai-insights.js agora usa DashboardLayout"
echo "   • Menu lateral será exibido em ambas as páginas"
echo ""
echo "🚀 Execute: npm run dev"
echo "🌐 Teste: http://localhost:3000/dashboard"
